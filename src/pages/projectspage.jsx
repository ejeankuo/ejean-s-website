    ...
    return (
      <div className="projects-page">
        ...
        <div className="project-card">
          <li>
            <a href="https://wurdle-mu.vercel.app/" target="_blank" rel="noopener noreferrer">
              <img src="/images/wurdle.webp" alt="Ranklit Logo" className="project-image" loading="eager"/>
            </a>
          </li>
          <p className="project-description">
            <strong> Tech Stack ––– React · JavaScript · Vercel </strong> <br /> <br />
        ...
        <div className="project-card">
          ...
          <p className="project-description">
            <strong> Tech Stack ––– React · TypeScript · Node.js/Express · Cors </strong> <br /> <br />
        ...
        <div className="project-card">
          ...
          <p className="project-description">
            <strong> Tech Stack ––– React · JavaScript · Node.js/Express · Supabase · Vercel </strong> <br /> <br />
